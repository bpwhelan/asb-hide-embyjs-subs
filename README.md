...
2. Click **[Install Script](https://raw.githubusercontent.com/bpwhelan/asb-hide-mediaserver-subs/main/asb-hide-mediaserver-subs.user.js)** — your userscript manager will intercept the `.user.js` URL and prompt you to install.
